...
//CreatePost method to create post with parameter
...
//GetPosts method to get all post
...
//GetPost method to get post by id
...
//UpdatePost method to update post with route parameter id
...
//DeletePost method to delete post from db
